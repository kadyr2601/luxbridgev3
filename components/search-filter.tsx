...
export function SearchFilter() {
    ...
    return (
        <div className="w-full bg-black/70 backdrop-blur-sm absolute bottom-0 z-10">
            <form onSubmit={handleSearch} className="w-full flex flex-wrap md:flex-nowrap">
                {/* Property Type Dropdown */}
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <Button
                            variant="ghost"
                            className="text-gray-400 h-14 px-4 border-r border-gray-400 bg-transparent hover:bg-white/10 rounded-none flex-shrink-0"
                        >
                ...
                <input
                    ...
                    className="h-14 px-4 py-2 flex-grow bg-transparent text-gray-400 border-none focus:outline-none focus:ring-0 min-w-[200px]"
                />
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <Button
                            variant="ghost"
                            className="h-14 px-4 border-l border-gray-400 text-gray-400 bg-transparent hover:bg-white/10 rounded-none flex-shrink-0"
                        >
                ...
                <Button
                    type="submit"
                    className="h-14 px-6 bg-black hover:bg-black/50 text-gray-400 rounded-none flex-shrink-0"
                >
